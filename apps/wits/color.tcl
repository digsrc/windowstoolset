...
#   Returns a #RRGGBB or #RRRRGGGGBBBB color
#
proc wits::color::dec2rgb {r {g 0} {b UNSET} {clip 0}} {
...
#
proc wits::color::shade {orig dest frac} {
...
#
proc wits::color::complement {orig {grays 1}} {
