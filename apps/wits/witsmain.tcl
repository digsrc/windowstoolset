...
#      [list witscloseall "Close all views" $witscloseallimg] \
    ...
    method _updateStatusBar {} {
        ...
        # The catch is needed because pdh_query_get will sometimes
        # error if counters have bogus values. This can happen
        # for CPU as frequencies change due to power saving etc.
        # (The error is generated by Windows itself)
        catch {
